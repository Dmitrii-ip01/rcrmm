...
class ModelExtensionRetailcrmCustomIcml extends Model
{
    protected $shop;
    protected $file;
    ...
    private function addOffers() {
        ...
        foreach ($products as $product) {
            ...
            foreach ($offers as $optionsString => $optionsValues) {
                ...
                if ($product['image_tablet']) {
                    $image = $this->generateImage($product['image_tablet']);
                    $e->appendChild($this->dd->createElement('pictureTablet'))
                        ->appendChild($this->dd->createTextNode($image));
                }


                if ($product['image_mobile']) {
		            $image = $this->generateImage($product['image_mobile']);
		            $e->appendChild($this->dd->createElement('pictureMobile'))
			            ->appendChild($this->dd->createTextNode($image));
