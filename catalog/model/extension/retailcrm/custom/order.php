...
class ModelExtensionRetailcrmCustomOrder extends Model {
    protected $settings;
    ...
    public function processOrder($order_data, $create = true) {
        ...
        foreach ($orderProducts as $product) {
            ...
            if (isset($this->settings[$this->moduleTitle . '_custom_field']) && $order_data['custom_field']) {
	            ...
	            $brand = $this->model_catalog_product->getProductBrand($product['product_id']);
	            $order['customFields'] = ['ip'=> $_SERVER['REMOTE_ADDR']];
                if(isset($brand)){
	                $order['customFields'] += ['brand'=>$brand['brand_name']];
                }
